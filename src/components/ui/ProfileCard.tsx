...
const ProfileCard = React.memo(ProfileCardComponent) as React.FC<ProfileCardProps>;
...
export default ProfileCard;
  ...
  return (
    ...
    >
      <div
        ref={wrapRef}
        className="pc-card-wrapper h-full w-full"
        style={cardStyle}
      >
        <section 
          ref={cardRef} 
            ...
            <div className="pc-content pc-avatar-content">
              ...
              <div className="pc-user-info">
                <div className="pc-user-details">
                  ...
                  <div className="pc-user-text">
                    <div className="pc-handle">@{name.split(' ')[0].toLowerCase()}</div>
                    <div className="pc-status">Instructor</div>
                  </div>
                </div>
